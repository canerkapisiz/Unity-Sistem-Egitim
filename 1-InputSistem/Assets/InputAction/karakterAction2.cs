...
//     version 1.7.0
//     from Assets/InputAction/karakterAction2.inputactions
//
...
public partial class @KarakterAction2: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @KarakterAction2()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""karakterAction2"",
    ""maps"": [
        {
            ""name"": ""PlayerControl"",
    ...
    {
        private @KarakterAction2 m_Wrapper;
        public PlayerControlActions(@KarakterAction2 wrapper) { m_Wrapper = wrapper; }
